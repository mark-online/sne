 ...
 *
 * AesBlockCipher xUnit �׽�Ʈ.
 */
class AesBlockCipherTest : public testing::Test
{
public:
    virtual void SetUp() override {
        cipher_ = security::BlockCipherFactory::create("aes").release();
    }
...
TEST_F(AesBlockCipherTest, testGetBlockSize)
{
    ASSERT_EQ(16, static_cast<int>(cipher_->getBlockSize())) <<
        "16 bytes align";
}


TEST_F(AesBlockCipherTest, testEncryptDecrypt)
{
...
TEST_F(AesBlockCipherTest, testMultipleEncryptDecrypt)
{
    const int count = 147;
